...
function createOscillators(total, octave, release) {
  ...
  for (var i = 0; i < total; i++) {
    ...
    osc_filtergraph.message("edit_freq", 300.289642 + octave*300);
    osc_filtergraph.message("edit_amp", 10.18  + octave*5.5);
    ...
    osc_2_filtergraph.message("edit_freq", 300.289642 + octave*300);
    osc_2_filtergraph.message("edit_amp", 10.18 + octave*5.5);
